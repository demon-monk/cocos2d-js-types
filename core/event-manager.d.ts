...
declare namespace cc {
    ...
    export class EventKeyboard extends Event {
        public constructor(keyCode:KeyboardCode, isPressed:boolean);
    }
...
// The event helper
    ...
    export class EventListener extends Class {
         ...
         *    });
         */
        public static create(obj: EventListenerDesc):EventListener;
    }
    ...
    interface EventListenerDesc {
        ...
        eventName?: string
        [k: string]: any
        // return value indicates the onTouchMoved or onTouchEnded will be invoked
        ...
        onTouchesBegan?: (touches: cc.Touch[], event: cc.Event) => boolean
        ...
        onKeyPressed?: (keyCode: cc.KeyboardCode, event: cc.EventKeyboard) => void
        onKeyReleased?: (event: cc.EventKeyboard) => void
        callback?: (event: cc.EventCustom) => void
    }
